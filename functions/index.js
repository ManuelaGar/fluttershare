...
exports.onDeletePost = functions.firestore
  ...
  exports.onCreateActivityFeedItem = functions.firestore
    ...
    .onCreate(async (snapshot, context) => {
      ...
      const cratedActivityFeedItem = snapshot.data();
      ...
      function sendNotification(androidNotificationToken, cratedActivityFeedItem) {
        let body;

        // 3) switch body value depending on notification type
        ...
        // 4) Create message for push sendNotification
        const message = {
          notification: {body},
